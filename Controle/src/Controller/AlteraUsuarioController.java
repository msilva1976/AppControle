...
public class AlteraUsuarioController implements Initializable {
    ...
    @FXML
    private Button btbatualizar;
    @FXML
    private Button btbcadastrousurariocancela;
    @FXML
    private Label lbid;
    @FXML
    private TextField txtcadastrusuarionome;
    @FXML
    private TextField txtcadastrusuariosenha;
    @FXML
    private TextField txtcadastrusuariousuario;
    @FXML
